...
import UnblockIcon from "./icons/UnblockIcon.vue";
...
const blockUnblock = ref(false);
const blockDialog = ref(false);
</script>
<template>
  <div v-if="chatDetail" class="customHeight">
    <div>
      <div class="d-flex align-center gap-3 pa-4 flex-wrap">
        <!---Topbar Row-->
        <div class="d-flex gap-2 align-center">
          ...
          <!---Name & Last seen-->
          <div>
            <h5 class="text-h5 mb-n1 poppins">{{ chatDetail.name }}</h5>
            <small class="textPrimary"> {{ chatDetail.status }} </small>
          </div>
        </div>
        <!---Topbar Icons-->
        <div class="ml-auto d-flex">
          <v-btn v-if="blockUnblock" icon variant="text" class="text-medium-emphasis" flat>
            <UnblockIcon width="22" height="22" />
          </v-btn>
          <v-btn v-else icon variant="text" class="text-medium-emphasis"  @click="blockDialog = true">
            <BlockIcon width="22" height="22" />
          </v-btn>
          <DialogModel
            v-model="blockDialog"
            title="BlockUser"
            text="Youaregoingtoblockthisuserareyousure"
          ...
          <DialogModel
            ...
            text="Onceyousuretodeletethisconversationyouwillnotbeabletoundothisaction"
          ...
          <div class="w-100">
            ...
            >
              ...
              >
                <div>
                  <small
                    class="font-weight-semibold text-sm-12 text-10 text-muted d-block mb-1"
                    v-if="chat.createdAt"
                  >
                    {{
